-- 007_scribe_document_only.sql
-- Minimal schema from scratch: SCRIBE + DOCUMENT only

-- Drop existing two tables if present (order matters)
...
-- Default scribe assignment if missing (defensive)
